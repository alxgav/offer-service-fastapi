...
class Offer(UUIDPkMixin, CreatedAtMixin, Base):
    ...
    offer_options: Mapped["OfferOption"] = relationship(
        "OfferOption", back_populates="offer"
    )
...
class OfferOption(UUIDPkMixin, Base):
    ...
    temporary_to: Mapped[datetime]
    offer: Mapped[Offer] = relationship("Offer", back_populates="options")
